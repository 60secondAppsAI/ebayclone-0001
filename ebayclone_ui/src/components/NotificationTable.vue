...
<template>
  ...
  <base-input label="DateSent" type="text" placeholder="Enter DateSent" v-model="notificationToAdd.dateSent"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'dateSent',
          ...
          sorter: true
          //sorter: (a, b) => a.dateSent - b.dateSent,
          //sorter: (a, b) => a.dateSent.localeCompare(b.dateSent),
        },
      ],
      pagination: {
        current: 1,
